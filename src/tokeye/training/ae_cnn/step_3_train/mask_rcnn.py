...
default_settings = {
    ...
    'model_save_path': 'model/mask_rcnn.pt',
    'num_epochs': 8,
    'batch_size': 32,
    'learning_rate': 0.001,  # Lower starting LR for AdamW
...
def train(settings=None):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename='mask_rcnn-{epoch:02d}-{train_loss:.4f}',
        save_top_k=1,
        monitor='train_loss',
        mode='min',
    )
...
if __name__ == '__main__':
    # python -m aemodes.pipeline.train.mask_rcnn
    train()
